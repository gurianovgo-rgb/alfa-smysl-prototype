    ...
    <div className="flex flex-col min-h-dvh bg-[#0a0a0a] screen-enter items-center justify-center px-5 py-12">
      <div className="absolute top-4 right-4">
        <button
          ...
          className="w-9 h-9 rounded-full bg-[#2a2a2a] flex items-center justify-center btn-press"
        >
      ...
      <div className="w-full max-w-[340px]">
        <div className="bg-[#1a1a1a] rounded-3xl p-6 fade-in">
          ...
          <div className="text-center mb-4">
            <p className="text-white font-bold mb-1" style={{ fontSize: withdrawAmount >= 10000 ? '40px' : '48px' }}>
          ...
          <div className="bg-[#0a0a0a] rounded-2xl p-3 text-center mb-5">
            <p className="text-white text-sm font-medium">Текущий счёт ·· 8645</p>
