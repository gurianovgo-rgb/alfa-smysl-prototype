...
export default function DepositAmount() {
  ...
  const canProceed = amount > 0 && amount <= 80
  ...
  return (
    <div className="flex flex-col min-h-dvh bg-[#0a0a0a] screen-enter" onClick={() => inputRef.current?.focus()}>
      ...
      <div className="px-4 pt-4 pb-4 flex items-center justify-between flex-shrink-0">
        <button onClick={(e) => { e.stopPropagation(); setScreen('deposit-source') }} className="btn-press p-1">
      ...
      <div className="px-4 flex items-end justify-between mb-4 flex-1">
        <div className="relative">
          ...
          <div className="flex items-baseline gap-2">
            <span className="text-white font-bold leading-none" style={{ fontSize: '56px' }}>
      ...
      <div className="px-4 mb-6">
        <button onClick={(e) => { e.stopPropagation(); setInput('80') }} className="btn-press">
