...
export default function AccountOpened() {
  ...
  return (
    <div className="flex flex-col min-h-dvh bg-[#0a0a0a] screen-enter items-center justify-between py-12 px-6">
      ...
      <div className="flex-1 flex flex-col items-center justify-center gap-6 text-center">
        <div className="pop-in" style={{ filter: 'drop-shadow(0 0 20px rgba(48,209,88,0.5))' }}>
          <img src={icons.greenCheck} className="w-20 h-20 object-contain" alt="" />
        </div>
